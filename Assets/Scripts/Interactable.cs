...
public abstract class Interactable : MonoBehaviour {
    ...
    private void Awake() {
        itemStyle = new GUIStyle() { normal = new GUIStyleState() { textColor = Color.white }, alignment = TextAnchor.MiddleCenter, fontSize = 20 };
        itemStyleSelected = new GUIStyle() { normal = new GUIStyleState() { textColor = Color.black }, alignment = TextAnchor.MiddleCenter, fontSize = 20 };
    }
    ...
    private static float ItemHeight = 35f;
